...
const enMessages = {
  ...
  'checker.broadResultsTitle': 'Many possible matches',
  'checker.broadResultsCopy':
    'Use filters to narrow by country, product type, issue, recall area, intended audience, or recent notices.',
  'checker.refineSource': 'Source: {label}',
  'checker.refineProductType': 'Type: {label}',
  'checker.refineIssue': 'Issue: {label}',
  ...
  'taxonomy.family.food-grocery': 'Food & Grocery',
  'taxonomy.family.baby-kids': 'Baby & Kids',
  'taxonomy.family.electronics-batteries': 'Electronics & Batteries',
  'taxonomy.family.home-appliances': 'Home Appliances',
  'taxonomy.family.furniture-household': 'Furniture & Household',
  'taxonomy.family.vehicles-mobility': 'Vehicles & Mobility',
  'taxonomy.family.sports-outdoor': 'Sports & Outdoor',
  'taxonomy.family.tools-equipment': 'Tools & Equipment',
  'taxonomy.family.clothing-accessories': 'Clothing & Accessories',
  'taxonomy.family.health-personal-care': 'Health & Personal Care',
  'taxonomy.family.chemicals-cleaning': 'Chemicals & Cleaning',
  'taxonomy.family.pet-products': 'Pet Products',
  'taxonomy.family.industrial-workplace': 'Industrial & Workplace',
  'taxonomy.family.other': 'Other',
  'taxonomy.family.unknown': 'Need Review',
  'source.market.united-states': 'United States',
  'source.market.canada': 'Canada',
  'source.market.european-union': 'European Union',
  'source.market.france': 'France',
  'source.market.united-kingdom': 'United Kingdom',
  'source.market.australia': 'Australia',
  'source.market.new-zealand': 'New Zealand',
  'source.market.hong-kong': 'Hong Kong',
  'source.market.australia-new-zealand': 'Australia & New Zealand',
...
export const productFamilyI18nKeys = {
  'food-grocery': 'taxonomy.family.food-grocery',
  'baby-kids': 'taxonomy.family.baby-kids',
  'electronics-batteries': 'taxonomy.family.electronics-batteries',
  'home-appliances': 'taxonomy.family.home-appliances',
  'furniture-household': 'taxonomy.family.furniture-household',
  'vehicles-mobility': 'taxonomy.family.vehicles-mobility',
  'sports-outdoor': 'taxonomy.family.sports-outdoor',
  'tools-equipment': 'taxonomy.family.tools-equipment',
  'clothing-accessories': 'taxonomy.family.clothing-accessories',
  'health-personal-care': 'taxonomy.family.health-personal-care',
  'chemicals-cleaning': 'taxonomy.family.chemicals-cleaning',
  'pet-products': 'taxonomy.family.pet-products',
  'industrial-workplace': 'taxonomy.family.industrial-workplace',
  other: 'taxonomy.family.other',
  unknown: 'taxonomy.family.unknown'
} as const satisfies Record<string, MessageKey>;

export function getProductFamilyI18nKey(productFamily: string): MessageKey {
  return productFamilyI18nKeys[productFamily as keyof typeof productFamilyI18nKeys] ?? 'taxonomy.family.other';
}

export const sourceLandingTitleI18nKeys = {
  '/us-product-recalls': 'source.market.united-states',
  '/canada-product-recalls': 'source.market.canada',
  '/eu-safety-gate-recalls': 'source.market.european-union',
  '/france-product-recalls': 'source.market.france',
  '/uk-food-recalls': 'source.market.united-kingdom',
  '/australia-product-recalls': 'source.market.australia',
  '/new-zealand-product-recalls': 'source.market.new-zealand',
  '/hong-kong-food-recalls': 'source.market.hong-kong',
  '/australia-new-zealand-food-recalls': 'source.market.australia-new-zealand'
} as const satisfies Record<string, MessageKey>;

export function getSourceLandingTitleI18nKey(route: string): MessageKey | undefined {
  return sourceLandingTitleI18nKeys[route as keyof typeof sourceLandingTitleI18nKeys];
}
...
export const messages: Record<SupportedLocale, Record<MessageKey, string>> = {
  ...
  ko: {
    ...
    'taxonomy.family.food-grocery': '식품·식료품',
    'taxonomy.family.baby-kids': '영유아·어린이',
    'taxonomy.family.electronics-batteries': '전자제품·배터리',
    'taxonomy.family.home-appliances': '가전제품',
    'taxonomy.family.furniture-household': '가구·생활용품',
    'taxonomy.family.vehicles-mobility': '차량·이동수단',
    'taxonomy.family.sports-outdoor': '스포츠·아웃도어',
    'taxonomy.family.tools-equipment': '공구·장비',
    'taxonomy.family.clothing-accessories': '의류·액세서리',
    'taxonomy.family.health-personal-care': '건강·개인관리',
    'taxonomy.family.chemicals-cleaning': '화학·청소용품',
    'taxonomy.family.pet-products': '반려동물 용품',
    'taxonomy.family.industrial-workplace': '산업·작업장',
    'taxonomy.family.other': '기타',
    'taxonomy.family.unknown': '검토 필요',
    'source.market.united-states': '미국',
    'source.market.canada': '캐나다',
    'source.market.european-union': '유럽연합',
    'source.market.france': '프랑스',
    'source.market.united-kingdom': '영국',
    'source.market.australia': '호주',
    'source.market.new-zealand': '뉴질랜드',
    'source.market.hong-kong': '홍콩',
    'source.market.australia-new-zealand': '호주·뉴질랜드',
  ...
  ja: {
    ...
    'taxonomy.family.food-grocery': '食品・食料品',
    'taxonomy.family.baby-kids': 'ベビー・子ども',
    'taxonomy.family.electronics-batteries': '電子機器・電池',
    'taxonomy.family.home-appliances': '家電',
    'taxonomy.family.furniture-household': '家具・生活用品',
    'taxonomy.family.vehicles-mobility': '車両・移動用品',
    'taxonomy.family.sports-outdoor': 'スポーツ・アウトドア',
    'taxonomy.family.tools-equipment': '工具・機器',
    'taxonomy.family.clothing-accessories': '衣類・アクセサリー',
    'taxonomy.family.health-personal-care': 'ヘルス・パーソナルケア',
    'taxonomy.family.chemicals-cleaning': '化学・清掃用品',
    'taxonomy.family.pet-products': 'ペット用品',
    'taxonomy.family.industrial-workplace': '産業・職場用品',
    'taxonomy.family.other': 'その他',
    'taxonomy.family.unknown': '要確認',
    'source.market.united-states': 'アメリカ',
    'source.market.canada': 'カナダ',
    'source.market.european-union': '欧州連合',
    'source.market.france': 'フランス',
    'source.market.united-kingdom': 'イギリス',
    'source.market.australia': 'オーストラリア',
    'source.market.new-zealand': 'ニュージーランド',
    'source.market.hong-kong': '香港',
    'source.market.australia-new-zealand': 'オーストラリア・ニュージーランド',
  ...
  zh: {
    ...
    'taxonomy.family.food-grocery': '食品与杂货',
    'taxonomy.family.baby-kids': '婴幼儿与儿童',
    'taxonomy.family.electronics-batteries': '电子产品与电池',
    'taxonomy.family.home-appliances': '家用电器',
    'taxonomy.family.furniture-household': '家具与家居',
    'taxonomy.family.vehicles-mobility': '车辆与出行',
    'taxonomy.family.sports-outdoor': '运动与户外',
    'taxonomy.family.tools-equipment': '工具与设备',
    'taxonomy.family.clothing-accessories': '服装与配饰',
    'taxonomy.family.health-personal-care': '健康与个护',
    'taxonomy.family.chemicals-cleaning': '化学与清洁用品',
    'taxonomy.family.pet-products': '宠物用品',
    'taxonomy.family.industrial-workplace': '工业与工作场所',
    'taxonomy.family.other': '其他',
    'taxonomy.family.unknown': '需要审核',
    'source.market.united-states': '美国',
    'source.market.canada': '加拿大',
    'source.market.european-union': '欧盟',
    'source.market.france': '法国',
    'source.market.united-kingdom': '英国',
    'source.market.australia': '澳大利亚',
    'source.market.new-zealand': '新西兰',
    'source.market.hong-kong': '香港',
    'source.market.australia-new-zealand': '澳大利亚与新西兰',
  ...
  fr: {
    ...
    'taxonomy.family.food-grocery': 'Alimentation',
    'taxonomy.family.baby-kids': 'Bébés et enfants',
    'taxonomy.family.electronics-batteries': 'Électronique et batteries',
    'taxonomy.family.home-appliances': 'Appareils ménagers',
    'taxonomy.family.furniture-household': 'Maison et mobilier',
    'taxonomy.family.vehicles-mobility': 'Véhicules et mobilité',
    'taxonomy.family.sports-outdoor': 'Sport et plein air',
    'taxonomy.family.tools-equipment': 'Outils et équipement',
    'taxonomy.family.clothing-accessories': 'Vêtements et accessoires',
    'taxonomy.family.health-personal-care': 'Santé et soins personnels',
    'taxonomy.family.chemicals-cleaning': 'Produits chimiques et nettoyage',
    'taxonomy.family.pet-products': 'Produits pour animaux',
    'taxonomy.family.industrial-workplace': 'Industrie et travail',
    'taxonomy.family.other': 'Autre',
    'taxonomy.family.unknown': 'À vérifier',
    'source.market.united-states': 'États-Unis',
    'source.market.canada': 'Canada',
    'source.market.european-union': 'Union européenne',
    'source.market.france': 'France',
    'source.market.united-kingdom': 'Royaume-Uni',
    'source.market.australia': 'Australie',
    'source.market.new-zealand': 'Nouvelle-Zélande',
    'source.market.hong-kong': 'Hong Kong',
    'source.market.australia-new-zealand': 'Australie et Nouvelle-Zélande',
  ...
  es: {
    ...
    'taxonomy.family.food-grocery': 'Alimentos y despensa',
    'taxonomy.family.baby-kids': 'Bebés y niños',
    'taxonomy.family.electronics-batteries': 'Electrónica y baterías',
    'taxonomy.family.home-appliances': 'Electrodomésticos',
    'taxonomy.family.furniture-household': 'Muebles y hogar',
    'taxonomy.family.vehicles-mobility': 'Vehículos y movilidad',
    'taxonomy.family.sports-outdoor': 'Deportes y aire libre',
    'taxonomy.family.tools-equipment': 'Herramientas y equipo',
    'taxonomy.family.clothing-accessories': 'Ropa y accesorios',
    'taxonomy.family.health-personal-care': 'Salud y cuidado personal',
    'taxonomy.family.chemicals-cleaning': 'Químicos y limpieza',
    'taxonomy.family.pet-products': 'Productos para mascotas',
    'taxonomy.family.industrial-workplace': 'Industria y trabajo',
    'taxonomy.family.other': 'Otros',
    'taxonomy.family.unknown': 'Requiere revisión',
    'source.market.united-states': 'Estados Unidos',
    'source.market.canada': 'Canadá',
    'source.market.european-union': 'Unión Europea',
    'source.market.france': 'Francia',
    'source.market.united-kingdom': 'Reino Unido',
    'source.market.australia': 'Australia',
    'source.market.new-zealand': 'Nueva Zelanda',
    'source.market.hong-kong': 'Hong Kong',
    'source.market.australia-new-zealand': 'Australia y Nueva Zelanda',
  ...
  de: {
    ...
    'taxonomy.family.food-grocery': 'Lebensmittel',
    'taxonomy.family.baby-kids': 'Baby und Kinder',
    'taxonomy.family.electronics-batteries': 'Elektronik und Batterien',
    'taxonomy.family.home-appliances': 'Haushaltsgeräte',
    'taxonomy.family.furniture-household': 'Möbel und Haushalt',
    'taxonomy.family.vehicles-mobility': 'Fahrzeuge und Mobilität',
    'taxonomy.family.sports-outdoor': 'Sport und Outdoor',
    'taxonomy.family.tools-equipment': 'Werkzeuge und Geräte',
    'taxonomy.family.clothing-accessories': 'Kleidung und Accessoires',
    'taxonomy.family.health-personal-care': 'Gesundheit und Körperpflege',
    'taxonomy.family.chemicals-cleaning': 'Chemikalien und Reinigung',
    'taxonomy.family.pet-products': 'Tierprodukte',
    'taxonomy.family.industrial-workplace': 'Industrie und Arbeitsplatz',
    'taxonomy.family.other': 'Andere',
    'taxonomy.family.unknown': 'Prüfung nötig',
    'source.market.united-states': 'Vereinigte Staaten',
    'source.market.canada': 'Kanada',
    'source.market.european-union': 'Europäische Union',
    'source.market.france': 'Frankreich',
    'source.market.united-kingdom': 'Vereinigtes Königreich',
    'source.market.australia': 'Australien',
    'source.market.new-zealand': 'Neuseeland',
    'source.market.hong-kong': 'Hongkong',
    'source.market.australia-new-zealand': 'Australien und Neuseeland',
  ...
  pt: {
    ...
    'taxonomy.family.food-grocery': 'Alimentos e mercado',
    'taxonomy.family.baby-kids': 'Bebês e crianças',
    'taxonomy.family.electronics-batteries': 'Eletrônicos e baterias',
    'taxonomy.family.home-appliances': 'Eletrodomésticos',
    'taxonomy.family.furniture-household': 'Móveis e casa',
    'taxonomy.family.vehicles-mobility': 'Veículos e mobilidade',
    'taxonomy.family.sports-outdoor': 'Esportes e ar livre',
    'taxonomy.family.tools-equipment': 'Ferramentas e equipamentos',
    'taxonomy.family.clothing-accessories': 'Roupas e acessórios',
    'taxonomy.family.health-personal-care': 'Saúde e cuidados pessoais',
    'taxonomy.family.chemicals-cleaning': 'Químicos e limpeza',
    'taxonomy.family.pet-products': 'Produtos para pets',
    'taxonomy.family.industrial-workplace': 'Indústria e trabalho',
    'taxonomy.family.other': 'Outros',
    'taxonomy.family.unknown': 'Revisão necessária',
    'source.market.united-states': 'Estados Unidos',
    'source.market.canada': 'Canadá',
    'source.market.european-union': 'União Europeia',
    'source.market.france': 'França',
    'source.market.united-kingdom': 'Reino Unido',
    'source.market.australia': 'Austrália',
    'source.market.new-zealand': 'Nova Zelândia',
    'source.market.hong-kong': 'Hong Kong',
    'source.market.australia-new-zealand': 'Austrália e Nova Zelândia',
