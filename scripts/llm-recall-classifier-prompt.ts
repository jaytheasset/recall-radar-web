...
export function buildRecallClassifierPromptFromInput(input: unknown, model = '', inputLabel = 'Recall input'): string {
  ...
  return [
    ...
    'Do not use productFamily values as productType values. If no narrower productType fits, use productType unknown.',
